          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-sm-7">
                  <input type="date" class="form-control" name="date" placeholder="Ingrese fecha" value="{{ old('date') }}" autofocus>
                  @if ($errors->has('date'))
              ...
              <div class="row">
                ...
                <div class="col-sm-7">
                  <input type="text" class="form-control" name="hour_c" placeholder="Ingrese la hora" value="{{ old('hour_c') }}" autofocus>
